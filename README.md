...
Look at the [documentation]([https://moongladesm.blob.core.windows.net/docs/_AdrTool/index.html](https://writebook.saschamanns.de/2/adr-tool)) for usage instructions.